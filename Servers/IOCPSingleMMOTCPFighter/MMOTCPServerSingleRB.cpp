...
MMOTCPServerSingleRB::MMOTCPServerSingleRB() : messageDataFreeList_(1000), characterFreeList_(1000)
{

	wprintf(L"MMOTCPServerSingleRB\n");
...
MMOTCPServerSingleRB::~MMOTCPServerSingleRB()
{

}

bool MMOTCPServerSingleRB::OnConnectionRequest(const wchar_t* serverIp, unsigned short serverPort)
{
	return false;
}

void MMOTCPServerSingleRB::OnAccept(const wchar_t* serverIp, unsigned short serverPort, SessionId sessionId)
{
...
void MMOTCPServerSingleRB::OnRelease(SessionId sessionId)
{
...
void MMOTCPServerSingleRB::OnMessage(SessionId sessionId, BYTE packetType, CPacket* contentsSendPacket)
{
...
void MMOTCPServerSingleRB::OnError(int errorCode, const wchar_t* errorLog)
{

}


unsigned int WINAPI MMOTCPServerSingleRB::LogicThread(LPVOID thisPtr)
{
	MMOTCPServerSingleRB* server = static_cast<MMOTCPServerSingleRB*>(thisPtr);
...
void MMOTCPServerSingleRB::MessageLoop()
{
	while (1)
	{
...
Character* MMOTCPServerSingleRB::CreateCharacter(SessionId sessionId)
{
...
void MMOTCPServerSingleRB::RegisterCharacter(Character* newPlayer)
{
...
void MMOTCPServerSingleRB::SendNewCharacterCreate(Character* newPlayer)
{
...
void MMOTCPServerSingleRB::SendExistingCharactersToNewCharacter(Character* newPlayer)
{
	SectorAround around;
...
void MMOTCPServerSingleRB::SendCharacterDelete(Character* target)
{
...
void MMOTCPServerSingleRB::UnregisterCharacter(Character* target)
{
...
void MMOTCPServerSingleRB::ReleaseCharacter(Character* target)
{
...
bool MMOTCPServerSingleRB::IsClientPositionValid(Character* target, unsigned short x, unsigned short y)
{
	return !((abs(target->x_ - x) > ErrorRange) || (abs(target->y_ - y) > ErrorRange));
}

void MMOTCPServerSingleRB::SendSync(Character* target)
{
...
void MMOTCPServerSingleRB::ApplyClientPosition(Character* target, unsigned short x, unsigned short y)
{
	target->x_ = x;
	target->y_ = y;
...
void MMOTCPServerSingleRB::SyncOrApplyClientPosition(Character* target, unsigned short x, unsigned short y)
{
...
void MMOTCPServerSingleRB::UpdateCharacterFacingDirection(Character* target, unsigned char direction)
{
	switch (direction)
	{
...
bool MMOTCPServerSingleRB::MessageProc(MessageData* msg)
{
	switch (msg->type_)
	{
...
bool MMOTCPServerSingleRB::PacketProc(MessageData* msg)
{
...
void MMOTCPServerSingleRB::AcceptProc(SessionId sessionId)
{
...
int MMOTCPServerSingleRB::ServerControl()
{
...
void MMOTCPServerSingleRB::AddMovingCharacter(Character* target)
{
...
void MMOTCPServerSingleRB::RemoveMovingCharacter(Character* target)
{
	if (target->movingIndex_ == -1)
	{
...
void MMOTCPServerSingleRB::MakePacketMoveStart(Character* target, CPacket* packet, unsigned int id, unsigned char direction, unsigned short x, unsigned short y)
{
...
void MMOTCPServerSingleRB::MakePacketMoveStartForMe(Character* target, CPacket* packet, unsigned int id, unsigned char direction, unsigned short x, unsigned short y)
{
	*packet << PacketScMoveStart << id << direction << x << y;
...
void MMOTCPServerSingleRB::MakePacketMoveStop(Character* target, CPacket* packet, unsigned int id, unsigned char direction, unsigned short x, unsigned short y)
{
...
void MMOTCPServerSingleRB::MakePacketCreateMyCharacter(Character* target, CPacket* packet, unsigned int id, unsigned char direction, unsigned short x, unsigned short y, unsigned char hp)
{
...
void MMOTCPServerSingleRB::MakePacketCreateOtherCharacterForMe(Character* target, CPacket* packet, unsigned int id, unsigned char direction, unsigned short x, unsigned short y, unsigned char hp)
{
...
void MMOTCPServerSingleRB::MakePacketCreateOtherCharacter(Character* target, CPacket* packet, unsigned int id, unsigned char direction, unsigned short x, unsigned short y, unsigned char hp)
{
	*packet << PacketScCreateOtherCharacter << id << direction << x << y << hp;
	SendPacketAround(target, packet);
}
...
void MMOTCPServerSingleRB::MakePacketDeleteCharacter(Character* target, CPacket* packet, unsigned int id)
{
...
void MMOTCPServerSingleRB::MakePacketDamage(Character* target, CPacket* packet, unsigned int attackId, unsigned int damageId, unsigned char damageHp)
{
...
void MMOTCPServerSingleRB::MakePacketAttack1(Character* target, CPacket* packet, unsigned int id, unsigned char direction, unsigned short x, unsigned short y)
{
...
void MMOTCPServerSingleRB::MakePacketAttack2(Character* target, CPacket* packet, unsigned int id, unsigned char direction, unsigned short x, unsigned short y)
{
...
void MMOTCPServerSingleRB::MakePacketAttack3(Character* target, CPacket* packet, unsigned int id, unsigned char direction, unsigned short x, unsigned short y)
{
	*packet << PacketScAttack3 << id << direction << x << y;
	SendPacketAround(target, packet);
}

void MMOTCPServerSingleRB::MakePacketEcho(Character* target, CPacket* packet, unsigned int time)
{
	*packet << PacketScEcho << time;
	SendPacketUnicast(target, packet);
}

void MMOTCPServerSingleRB::MakePacketDeleteCharacterRemoveSector(CPacket* packet, SectorAround* around, unsigned int id)
{
	*packet << PacketScDeleteCharacter << id;
	SendPacketToSectors(packet, around);
}

void MMOTCPServerSingleRB::MakePacketCreateCharacterAddSector(CPacket* packet, SectorAround* around, unsigned int id, unsigned char direction, unsigned short x, unsigned short y, unsigned char hp)
{
	*packet << PacketScCreateOtherCharacter << id << direction << x << y << hp;
	SendPacketToSectors(packet, around);
}

void MMOTCPServerSingleRB::MakePacketMoveStartAddSector(CPacket* packet, SectorAround* around, unsigned int id, unsigned char direction, unsigned short x, unsigned short y)
{
	*packet << PacketScMoveStart << id << direction << x << y;
	SendPacketToSectors(packet, around);
}

void MMOTCPServerSingleRB::MakePacketDeleteCharacterForMe(Character* target, CPacket* packet, unsigned int id)
{
	*packet << PacketScDeleteCharacter << id;
	SendPacketUnicast(target, packet);
...
void MMOTCPServerSingleRB::MakePacketSync(Character* target, CPacket* packet, unsigned int id, unsigned short x, unsigned short y)
{
...
void MMOTCPServerSingleRB::SendPacketUnicast(Character* target, CPacket* packet)
{
	SendPacket(target->sessionId_, packet);
}

void MMOTCPServerSingleRB::SendPacketAround(Character* target, CPacket* packet, bool sendMe)
{
...
void MMOTCPServerSingleRB::SendPacketToSectors(CPacket* packet, SectorAround* around, SessionId exceptSessionId)
{
...
void MMOTCPServerSingleRB::GetSectorAroundForHit(Character* target, int boundaryX, int boundaryY, SectorAround* aroundSector)
{
...
void MMOTCPServerSingleRB::AddSectorPosition(SectorAround* aroundSector, int sectorX, int sectorY)
{
...
bool MMOTCPServerSingleRB::CanHitTarget(const Character* attackCharacter, const Character* target, int boundaryX, int boundaryY)
{
...
void MMOTCPServerSingleRB::InitializeSectorUpdateAround()
{
...
void MMOTCPServerSingleRB::BuildSectorUpdateAround(int oldSectorX, int oldSectorY, int curSectorX, int curSectorY, SectorUpdateAround* sectorUpdateAround)
{
...
void MMOTCPServerSingleRB::SendPacketSectorOne(int sectorX, int sectorY, SessionId exceptSessionId, CPacket* packet)
{
	Character* target;
	std::list<Character*>::iterator iter;
...
bool MMOTCPServerSingleRB::NetPacketProcMoveStart(SessionId sessionId, unsigned char direction, unsigned short x, unsigned short y)
{
...
bool MMOTCPServerSingleRB::NetPacketProcMoveStop(SessionId sessionId, unsigned char direction, unsigned short x, unsigned short y)
{
...
bool MMOTCPServerSingleRB::NetPacketProcAttack1(SessionId sessionId, unsigned char direction, unsigned short x, unsigned short y)
{
...
bool MMOTCPServerSingleRB::NetPacketProcAttack2(SessionId sessionId, unsigned char direction, unsigned short x, unsigned short y)
{
	Profile profile(L"NetPacketProcAttack");
	Character* target = characterMap_.at(sessionId);
...
bool MMOTCPServerSingleRB::NetPacketProcAttack3(SessionId sessionId, unsigned char direction, unsigned short x, unsigned short y)
{
	Profile profile(L"NetPacketProcAttack");
	Character* target = characterMap_.at(sessionId);
...
bool MMOTCPServerSingleRB::NetPacketProcEcho(SessionId sessionId, unsigned int time)
{
...
bool MMOTCPServerSingleRB::SectorUpdateCharacter(Character* target)
{
...
void MMOTCPServerSingleRB::SectorUpdate(Character* target)
{
...
void MMOTCPServerSingleRB::SendRemoveSectorUpdate(Character* target, SectorAround* removeSector)
{
...
void MMOTCPServerSingleRB::SendAddSectorUpdate(Character* target, SectorAround* addSector)
{
...
void MMOTCPServerSingleRB::HitCheck(Character* attackCharacter, int attackNumber)
{
...
void MMOTCPServerSingleRB::GetSectorAround(int sectorX, int sectorY, SectorAround* aroundSector)
{
...
SectorUpdateAround* MMOTCPServerSingleRB::GetUpdateSectorAround(Character* target)
{
...
void MMOTCPServerSingleRB::Update()
{
...
void MMOTCPServerSingleRB::GameRun(Character* target)
{
