...
#define MAXCHATSIZE 200

#define MAXSECTORX 50
#define MAXSECTORY 50

#define INITSECTORX 51
#define INITSECTORY 51

#define AUTHTHREADS 5

#define MAXTIMEOUT 40000
...
{
	dfMONITOR_SERVER_TYPE_SYSTEM = 0,
